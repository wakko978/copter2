class Ravendor < General
  ...
  def attack_with_mods(profile,recruit)
    ...
    attack += 2 if profile.inventory_exists?('weapons','Raven Blight')
    attack += 2 if profile.inventory_exists?('powers','Ravens Grasp')
  ...
  def defense_with_mods(profile,recruit)
    ...
    defense += 2 if profile.inventory_exists?('items','Nalzir Robes')
